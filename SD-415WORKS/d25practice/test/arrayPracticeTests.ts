...
import { Person, doubleNums, doubleAges,filterEven,filterOver10,findEvenNum,findEvenAge,includesEvenNum,includesEvenAge, includesOddNum} from "../src/arrayPractice.js";
...
describe("filter practice", function () {
    ...
    it("includes even", function () {
        ...
        assert.strictEqual(includesOddNum(numArray), false);
    });

    /* complete the following similar to includes even test */
    it("includes even age and odd age", function () {
